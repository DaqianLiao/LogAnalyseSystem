...
def analysFile(file_path):
    ...
    list_map4 = publicfunction.PublicProcessFunction.get_function_Unit(lines, date_time, ticks, pown_off)
    list_map5 = publicfunction.PublicProcessFunction.get_function_Unit(lines, date_time, ticks, Vsim_data_success)
...
def  analys_txtfile_all(log_path):    
    for dirpath, dirnames, filenames in os.walk(log_path):
        ...
        if TxtList:
           ...
           sStr1 = 'remalloc_sim_model_restart_analyze_' + time_str + '.xls'
