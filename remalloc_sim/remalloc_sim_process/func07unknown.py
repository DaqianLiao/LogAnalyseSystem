...
exception_id = r'exception_id = (0x02000006|0x02000013|0x02000014|0x02000029|0x02000028)'
...
##    print('{%s}total line:%d'%(file_path,len(lines)))
    ...
    list_map3 = publicfunction.PublicProcessFunction.get_function_Unit(lines, date_time, ticks, sim_card_type)
...
def  analys_txtfile_all(log_path):    
    for dirpath, dirnames, filenames in os.walk(log_path):
        ...
        if TxtList:
           ...
           sStr1 = 'remalloc_unknown_analyze_' + time_str + '.xls'
