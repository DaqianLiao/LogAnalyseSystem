...
def analysFile(file_path):
    ...
    list_map3 = publicfunction.PublicProcessFunction.get_function_Unit(lines, date_time, ticks, Power_off)
...
def  analys_txtfile_all(log_path):    
    for dirpath, dirnames, filenames in os.walk(log_path):
        ...
        if TxtList:
           ...
           sStr1 = 'remalloc_sim_token_exception_analyze_' + time_str + '.xls'
...
def token_exception_main(log_path):
