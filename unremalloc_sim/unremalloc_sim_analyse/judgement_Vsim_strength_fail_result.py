...
def Vsim_strength_fail_main(xls_file_path):
   regular_key_sequence = r'cd{10,}[efg]'
   Key_list = ['function', 'number', 'strength_in_percentage', 'service_availability', 'PushRemalloc', 'Power off', 'simo_local_rev_channel_payload']
   xls_file_name = 'unremalloc_Vsim_strength_fail_analyze'
   output_xls_file_name = '_unremalloc_Vsim_strength_fail_result.xls'
