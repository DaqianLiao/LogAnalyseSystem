...
ticks = r'ticks:(\d+)'
ticks_name = 'ticks'
Vsim_protocol = r'_simo_nw_info_trace_check.*protocol = \d{1,3}\D'
exception_id = r'exception_id = 0x0200001[3-4]'
...
##    print('{%s}total line:%d'%(file_path,len(lines)))
    list_map1 = publicfunction.PublicProcessFunction.get_function_Unit(lines, date_time, ticks, Vsim_protocol)
